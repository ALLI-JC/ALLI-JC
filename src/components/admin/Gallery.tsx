    ...
    <div className="flex flex-col items-center justify-center py-20">
      <div className="relative">
        ...
        <div className="absolute inset-0 flex items-center justify-center">
          <ImageIcon size={24} className="text-[var(--primary)] animate-pulse" />
        </div>
      </div>
  ...
  return (
    <div
      ...
      className={`group relative bg-white rounded-2xl overflow-hidden shadow-lg hover:shadow-2xl transition-all duration-500 cursor-grab active:cursor-grabbing ${
        isDragging ? 'opacity-40 scale-95 ring-2 ring-[var(--primary)]' : 'hover:-translate-y-1'
      }`}
    >
      {/* Image Container */}
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-5 overflow-y-auto max-h-[calc(90vh-80px)]">
          ...
          <div>
            ...
            <div 
              className={`relative rounded-xl border-2 border-dashed transition-all ${
                previewUrl ? 'border-[var(--primary)] bg-[var(--primary)]/5' : 'border-gray-300 hover:border-[var(--primary)] bg-gray-50'
              }`}
            >
              {previewUrl ? (
                ...
                >
                  <div className="w-20 h-20 mx-auto bg-gradient-to-br from-[var(--primary)]/20 to-[var(--primary)]/20 rounded-2xl flex items-center justify-center group-hover:scale-110 transition-transform mb-3">
          ...
          <div>
            ...
            <input
              ...
              className="w-full px-4 py-2.5 border border-gray-200 rounded-xl focus:outline-none focus:border-[var(--primary)] focus:ring-2 focus:ring-[var(--primary)]/20 transition"
          ...
          <div>
            ...
            <textarea
              ...
              rows={3}
              className="w-full px-4 py-2.5 border border-gray-200 rounded-xl focus:outline-none focus:border-[var(--primary)] focus:ring-2 focus:ring-[var(--primary)]/20 transition resize-none"
          ...
          <label className="flex items-center justify-between p-4 bg-gradient-to-r from-gray-50 to-white rounded-xl cursor-pointer hover:shadow-md transition">
            ...
            <div className="relative">
              ...
              />
              <div className="w-11 h-6 bg-gray-300 rounded-full peer peer-checked:bg-[var(--primary)] transition-all"></div>
          ...
          <div className="flex gap-3 pt-4">
            ...
            <button
              ...
              className="flex-1 bg-gradient-to-r from-[var(--primary)] to-[var(--primary)] text-white py-2.5 rounded-xl font-semibold hover:shadow-lg disabled:opacity-50 disabled:cursor-not-allowed transition-all transform hover:scale-105"
            >
              {uploading ? (
          ...
          {stats.categories.map(cat => (
            <button
              ...
              className={`${cat.bgColor} rounded-xl p-3 text-center transition-all hover:scale-105 ${
                selectedCategory === cat.id ? 'ring-2 ring-[var(--primary)] shadow-md' : ''
              }`}
            >
              <span className="text-2xl">{cat.icon}</span>
              <p className="text-xs font-medium text-gray-700 mt-1 hidden sm:block">{cat.label}</p>
              <p className="text-lg font-bold text-[var(--primary)]">{cat.count}</p>
            </button>
          ))}
        </div>
        ...
        <div className="flex flex-col sm:flex-row gap-4 mb-8">
          <div className="flex-1 relative">
            ...
            <input
              ...
              className="w-full pl-11 pr-4 py-2.5 bg-white border border-gray-200 rounded-xl focus:outline-none focus:border-[var(--primary)] focus:ring-2 focus:ring-[var(--primary)]/20 transition"
            />
          </div>
          ...
          <div className="flex gap-2">
            <button
              ...
              className={`p-2.5 rounded-xl transition ${
                viewMode === 'grid' ? 'bg-[var(--primary)] text-white shadow-md' : 'bg-white text-gray-400 hover:text-gray-600'
              }`}
            >
              <Grid3x3 size={18} />
            </button>
            <button
              ...
              className={`p-2.5 rounded-xl transition ${
                viewMode === 'list' ? 'bg-[var(--primary)] text-white shadow-md' : 'bg-white text-gray-400 hover:text-gray-600'
              }`}
            >
              <List size={18} />
            </button>
